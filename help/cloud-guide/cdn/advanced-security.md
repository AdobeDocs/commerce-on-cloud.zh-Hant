...
>
>如需任何規則的新增、修改或調整，請透過[支援票證](https://experienceleague.adobe.com/home?support-tab=home#support)聯絡Adobe Commerce支援。 支援團隊將實施要求的變更。
>
...
1. 購買[!DNL Advanced Security]後，[提交Adobe Commerce支援票證](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket)，要求[!DNL Advanced Security]啟用。 包含您的[!DNL Adobe Commerce on Cloud Infrastructure]專案ID和需要啟用的環境（例如，生產和測試）。
...
>[!NOTE]
>
>對[!DNL Advanced Security]的組態變更目前需要[提交支援票證](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#submit-ticket)。 計畫在未來版本中透過管理員UI進行自助設定。
