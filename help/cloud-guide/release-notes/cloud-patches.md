...
- ![修正圖示](../../assets/fix.svg) **修補程式** — 啟用JS縮制和套件組合時，[簽出失敗](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997))，如*Commerce Knowledgebase&quot; (AC-15867和ACSD-68617)中所述。<!-- MCLOUD-14191 -->
