...
- ![修正圖示](../../assets/fix.svg) **中斷簽出的修補程式** — 修正(AC-15867)與Newrelic (ACSD-68617)。<!-- MCLOUD-14191 -->
...
- ![修正圖示](../../assets/fix.svg) **已改善的類別檢視**-MCLOUD-13752:Improve類別檢視。<!-- MCLOUD-13752 | MCLOUD-14139  - -->
