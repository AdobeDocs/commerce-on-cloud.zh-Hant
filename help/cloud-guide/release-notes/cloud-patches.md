...
- ![修正圖示](../../assets/fix.svg) **安全性改善** — 已套用[Adobe Commerce安全性更新APSB26-146](https://helpx.adobe.com/tw/security/products/magento/apsb26-146.html)中參考的安全性修正。<!--MCLOUD-15587 -->

## v1.1.20

發行日期： 2026年9月08日

- ![修正圖示](../../assets/fix.svg) **安全性改善** — 包含對[Adobe Commerce安全性更新APSB26-138](https://helpx.adobe.com/tw/security/products/magento/apsb26-138.html)中參考的2026年9月隔離安全性修補程式的支援。<!-- MCLOUD-15053 -->
...
- ![修正圖示](../../assets/fix.svg) **增強的Symfony L2快取效能和可靠性** — 已針對symfony_l2最佳化快取標籤儲存、改善快取失效，以及預設啟用Redis/Valkey壓縮(compress_data)，以減少記憶體耗用和網路流量。<!-- ACP2E-5132 -->
...
- ![修正圖示](../../assets/fix.svg) **修補程式版本可見性** — 修正雲端環境中的雲端修補程式版本可見性。<!--MCLOUD-14221 -->
- ![修正圖示](../../assets/fix.svg) **PHPUnit清理** — 修正PHPUnit通知<!--MCLOUD-14717 -->
- ![新圖示&#x200B;](../../assets/new.svg)**裝飾修正** — 新增裝飾改善。<!--MCLOUD-14686 -->

## v1.1.13

發行日期： 2026年3月5日

- ![新圖示](../../assets/new.svg) **PHP 8.5** — 已新增對PHP 8.5的支援。<!-- MCLOUD-14181 -->
- ![修正圖示](../../assets/fix.svg) **已更新PHP 8.x的功能測試** — 已移除舊版PHP 7.x測試、新增PHP 8.1和8.2測試涵蓋範圍以及已更新Adobe Commerce版本。<!-- MCLOUD-14203 -->
...
- ![修正圖示](../../assets/fix.svg) **修補程式** — 啟用JS縮制和套件組合時，[簽出的修正會失敗](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-27997)問題，如&#x200B;*Commerce知識庫*&#x200B;所述。
- ![修正圖示](../../assets/fix.svg) **已改善的類別檢視**—MCLOUD-13752：已改善類別檢視。<!-- MCLOUD-13752 | MCLOUD-14139  -->

## v1.1.11

發行日期： 2025年9月9日

- ![修正圖示](../../assets/fix.svg) **WebAPI**—CVE-2025-54236的修正。<!-- MCLOUD-14016 -->
...
- ![修正圖示](../../assets/fix.svg) **已改善的類別檢視** — 已改善類別檢視。<!-- MCLOUD-13752     - -->
- ![修正圖示](../../assets/fix.svg) **已改善管理快取** — 改善管理快取效率CVE-2025-47110。<!-- MCLOUD-13753     - -->

## v1.1.8

發行日期： 2025年6月3日

- ![修正圖示](../../assets/fix.svg) **改善與2.4.8**&#x200B;的相容性 — 更新協力廠商程式庫以提供與2.4.8<!-- MCLOUD-13707     - -->的更好相容性
...
- ![新圖示](../../assets/new.svg) **已將Commerce 2.4.4的修補程式更新至2.4.7** — 此更新是[CVE-2025-24434](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-27149)的更新修補程式，已在1.1.4<!-- MCLOUD-13240 -->中發行
...
- ![新圖示](../../assets/new.svg) **已新增Commerce 2.4.4至2.4.7**&#x200B;的修補程式 — 此更新修補程式[CVE-2025-24434](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-27149)。<!-- MCLOUD-13240     - -->
...
- ![修正圖示](../../assets/fix.svg) **已新增Commerce 2.4.4至2.4.7**&#x200B;的修補程式 — 此更新修正使用B2B模組時Adobe Commerce的嚴重[CVE-2024-45115](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-27151)漏洞。<!-- MCLOUD-12980 - -->

## v1.1.1

發行日期： 2024年11月5日

- ![修正圖示](../../assets/fix.svg) **已新增Commerce 2.4.4至2.4.7**&#x200B;的修補程式 — 此更新可修補嚴重的[CVE-2024-34102](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-27136) CosmicSting漏洞。<!-- MCLOUD-12980 - -->
...
- **快取改善** — 此修補程式可增強Adobe Commerce 2.4.4版和更新版本的版面快取效率，減少記憶體使用量。<!-- MCLOUD-11514 -->
...
請參閱[啟用Braintree付款時，管理員無法建立訂單/重新排序](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-27169)。
...
- **PHP錯誤** — 已修正`PHP error 'Undefined variable: errorMessage' ...`錯誤。 嘗試套用修補程式時發生此錯誤。<!-- ACP2E-138 -->
...
- **API速率限制問題** — 此修補程式更正了預設速率限制，該限制導致Web API無法處理陣列中超過20個專案的請求。 此修補程式會提高速率限制的預設值。 請參閱Adobe Commerce [2.4.3發行說明](https://experienceleague.adobe.com/zh-hant/docs/commerce-operations/release/notes/adobe-commerce/2-4-3#apply-mc-43048__set_rate_limits__243patch-to-address-issue-with-api-rate-limiting).<!-- MC-43048 -->
...
- **修正多次套用隨附修補程式所造成的問題** — 多次套用隨附修補程式（包含其他已棄用的修補程式）會還原包含的已棄用套件。 所有修補程式現在只會套用一次。 嘗試再次套用相同的套件時，會顯示已套用修補程式的訊息。<!--MC-41912-->
...
- **已棄用的修補程式會變為可見** — 修正了雲端修補程式的問題，此問題導致在套用包含已棄用修補程式全部內容的取代修補程式後，已棄用的修補程式會顯示在修補程式表格中。 如果您套用的修補程式結合了數個其他修補程式，就會發生這種情況。<!--MC-40626-->
...
- **magento/magento-cloud-patches的相容性更新** — 更新`composer.json`檔案中的`symfony`和`semver`版本限制，以便與Adobe Commerce 2.4.1和更新版本相容。<!--MCLOUD-7111-->
...
- **Redis效能改善** — 將Redis最佳化功能新增至Adobe Commerce 2.3.3和2.3.4版。 這些修正包含在Adobe Commerce 2.3.5版本中。<!--MCLOUD-5771-->
...
- **PayPal Express結帳** — 此修補程式解決手動輸入運送地址國家/地區而不是從下拉式功能表中選取的問題。 請參閱修正程式下載頁面上的完整修正程式說明。
...
所有Magento Open Source 2.x修補程式（從軟體下載頁面取得）都包含在magento/magento-cloud-patches v1.0.1版中。 若要避免衝突，請移除先前複製到專案中的任何修補程式。

此版本包含下列修補程式和重要修正：

- **修正Cron死結並改善Cron鎖定**—

  - 修正由於`cron_schedule`表格中的狀態值不正確，導致部分cron工作無法執行的問題。 現在，Adobe Commerce鎖定架構是用來檢查及更新cron工作狀態，而非使用`cron_schedule`表格。 已結束並出現錯誤狀態的Cron工作會在下次Cron執行時重試，而不是等待24小時。

  - 若要避免在更新`cron_schedule`資料表中的資料時發生死結，請新增&#x200B;_重試_&#x200B;作業。
...
- **Page Builder修補程式** — 在Commerce 1.0.0的Cloud Patches中，Page Builder修補程式已搭配使用，以解決已知的Page Builder遠端程式碼執行(RCE)弱點，並以Adobe Commerce 2.3.3為基礎進行初始修正。 這些修補程式已更新為以Adobe Commerce 2.3.4為基礎的更穩定實作，其中包括修正問題的多項最佳化。<!--MAGECLOUD-4884-->
...
- **2.3.1.x和2.3.2.x版本的Page Builder安全性修補程式** — 修正Page Builder預覽問題，此問題允許未經驗證的使用者觸發任意程式碼執行(RCE)和全域資訊洩漏。 在Adobe Commerce 2.3.1和2.3.2.<!--MAGECLOUD-4649-->版中使用不支援的頁面產生器版本時，可能會發生此問題
