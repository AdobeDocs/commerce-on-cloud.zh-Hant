...
>
>若要啟用您專屬的SendGrid服務或更新現有的API金鑰，請[提交Adobe Commerce支援票證](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#submit-ticket)，並包含您SendGrid帳戶的API金鑰。
