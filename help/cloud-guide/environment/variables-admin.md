...
根據預設，[Commerce管理員](https://experienceleague.adobe.com/docs/commerce-admin/start/admin/admin.html?lang=zh-Hant) URL已設為&#x200B;*&lt;domain_name>/admin*。 基於安全考量，Adobe建議將其變更為不容易猜測的唯一自訂管理員URL。
