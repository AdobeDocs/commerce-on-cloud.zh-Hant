...
您可以將Adobe Commerce程式碼基底升級至較新版本。 升級專案之前，請檢閱[安裝](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/system-requirements.html?lang=zh-Hant)指南中的&#x200B;_系統需求_，以取得最新的軟體版本需求。
